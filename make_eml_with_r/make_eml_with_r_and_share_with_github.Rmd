...
- The paragraph breaks have been recognized by `set_methods`. This function also recognizes more detailed formatting from Microsoft Word and other markdown documents. Careful not to use special characters and non-UTF-8 characters and symbols. EML can't handle them. As a result the EML document becomes invalid. So make a consious effort to present your text based inputs to EML with the bare essentials and as little formatting and symbolization as possible.
...
- Create a clone of this remote repository on the local workspace of our computer:
    ...
    - Return to RStudio and paste the URL in the _Repository URL_ field. Be sure to set the parent directory for the local version of this remote repository. Click _Create Project_. This will create a new Git version controlled RStudio project at the specified location. This project is a clone of the remote repository you set up in GitHub. Take a look at the contents. You should see a copy of the README file you created there.

- Now if you return to the RStudio environment you will see some new feature. In the _Environment and History window you should see a tab called Git. This tab contains a GUI interface for you to control version control of files in this projects directory.
...
- Copy the files from your directory _dataset\_eml_ into your newly cloned _eml\_project.
